          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                {t(
                  "We started serving 23 years ago on Mehmet Akif Street, one of the most popular areas of Lefkoşa. During this time, we have continuously expanded our customer portfolio with our quality service approach and reliable products.",
