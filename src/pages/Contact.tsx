  ...
  return (
    <Layout>
      ...
      <section className="relative py-20 md:py-32 bg-charcoal">
        ...
        <div className="container mx-auto px-4 md:px-6 relative text-center text-cream">
          <motion.p
          ...
          <motion.h1
            ...
            className="font-serif text-4xl md:text-5xl lg:text-7xl font-bold"
          >
      ...
      <section className="py-12 md:py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16">
            ...
            >
              ...
              {isSubmitted ? (
                <motion.div
                  ...
                  className="bg-card p-6 md:p-8 rounded-2xl text-center"
                >
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <div>
                      <Label htmlFor="subject" className="text-sm">{t("Subject", "Konu")} *</Label>
                      <Input
                        id="subject"
                  ...
                  <div>
                    <Label htmlFor="message" className="text-sm">{t("Message", "Mesaj")} *</Label>
                    <Textarea
                      id="message"
                      value={formData.message}
                      onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                      required
                      className="mt-1.5 md:mt-2 min-h-[120px] md:min-h-[150px]"
                  ...
                  <Button
                    ...
                    className="w-full bg-primary hover:bg-primary/90 text-primary-foreground py-5 md:py-6"
                  >
                    {isSubmitting ? (
            ...
            >
              {/* Contact Details */}
              <div className="bg-card p-5 md:p-8 rounded-2xl">
                <h3 className="font-serif text-xl md:text-2xl font-bold mb-4 md:mb-6">
                  ...
                  {contactInfo.map((item, index) => (
                    <div key={index} className="flex items-start gap-3 md:gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-xs md:text-sm text-muted-foreground mb-0.5 md:mb-1">{item.label}</p>
                        {item.href ? (
                          <a
                            href={item.href}
                ...
                <div className="space-y-3 md:space-y-4">
                  {BRANCHES.map((branch) => (
                    <a
                      ...
                      className="flex items-start gap-3 p-3 md:p-4 bg-background rounded-xl hover:bg-muted transition-colors group"
                    >
